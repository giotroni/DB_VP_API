...
--  Generato il 20/08/2026 dagli script di docker/initdb
-- =====================================================================
--
...
--
--  Contiene, nell'ordine, dodici script gia' verificati in locale:
--
...
--    14  timbra come SYSTEM le righe che la catena ha toccato
--
...
--  anche le colonne di regime, che le aggiunge l'11. Il 14 deve stare per
--  ultimo, perche' timbra tutto quello che gli altri hanno modificato.
--
...
-- L'istante in cui la catena comincia, preso PRIMA che qualunque script
-- tocchi qualcosa. Serve solo allo script 14, che da qui riconosce le righe
-- modificate dal rilascio e le distingue da quelle che portano ancora la data
-- del dump. Va preso qui e non li': dopo, sarebbe gia' tardi.
SET @rilascio := NOW();
