...
try {
    ...
    LEFT JOIN
        ANA_COMMESSE cm ON at.ID_COMMESSA = cm.ID_COMMESSA
    LEFT JOIN
        ANA_CLIENTI c ON cm.ID_CLIENTE = c.ID_CLIENTE
    LEFT JOIN
        ANA_COLLABORATORI co ON fg.ID_COLLABORATORE = co.ID_COLLABORATORE
    LEFT JOIN
