...
| 14 | `14-timbro-sistema.sql` | timbra come `SYSTEM` le righe che la catena ha modificato, così il registro attività non si riempie di eventi senza nome. Solo dove il nome manca |
