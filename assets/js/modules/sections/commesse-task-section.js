        ...
        container.innerHTML = `
            ...
            <div class="search-filters">
                <div class="row gy-3">
                    ...
                    <div class="col-lg-2 col-md-6"><label class="form-label">Stato</label><select class="form-select" id="filterStatoCommesse"><option value="">Tutti</option><option value="In corso">In corso</option><option value="Chiusa" selected>Chiusa</option><option value="Sospesa">Sospesa</option></select></div>
